...
export const blogIndex = register({
  ...
  blocks: [
    ...
    { t: 'crumbs' },
    { t: 'posts', items: [
      { href: 'blog-workers-comp.html', img: 'assets/equipment.jpg', cat: 'WorkCover',
      ...
      { href: 'blog-first-visit.html', img: 'assets/clinic.jpg', cat: 'Getting started',
      ...
      { href: 'blog-dapto-questions.html', img: 'assets/gym.jpg', cat: 'FAQs',
